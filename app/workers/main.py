...
from db.parser import Tag, Data, get_media_type, pdf_to_text, is_url
from nlp.main import get_ner_tags
from db.utils import text_to_chunks, clean_text
...
def add_data_task(data_dict):
    ...
    # Convert dict to Data object (depending on how you're structuring things)
    data = Data(**data_dict)
